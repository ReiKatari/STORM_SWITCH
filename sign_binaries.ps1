...
Write-Host "Copying freshly compiled 8.3.2 binaries from build_ninja\bin to Assembling..."
...
$zipPathWin11 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.3.2_Windows11.zip'
...
$zipPathWin10 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.3.2_Windows10.zip'
...
Write-Host "All Windows 8.3.2 executables signed and packaged successfully into E:\STORM SWITCH 4\Files!"
