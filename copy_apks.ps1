...
Write-Host "Copying APKs with STORM_SWITCH_8.7.4 naming to E:\STORM SWITCH 4\Files..."
if (Test-Path $mainline) {
    Copy-Item $mainline 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.7.4.apk' -Force
}

if (Test-Path $legacy) {
    Copy-Item $legacy 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.7.4_LEGACY.apk' -Force
}

if (Test-Path $sdk27) {
    Copy-Item $sdk27 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.7.4_SDK27.apk' -Force
}
...
Write-Host "All 8.7.4 APKs copied to E:\STORM SWITCH 4\Files and unblocked successfully!"
