...
Write-Host "Copying freshly compiled 9.0.3 binaries from build_ninja\bin to Assembling..."
...
$zipPathWin11 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_9.0.3_Windows11.zip'
...
$zipPathWin10 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_9.0.3_Windows10.zip'
...
Write-Host "All Windows 9.0.3 executables signed and packaged successfully into E:\STORM SWITCH 4\Files!"
