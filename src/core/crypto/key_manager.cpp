...
void KeyManager::ReloadKeys() {
    ...
    std::vector<std::filesystem::path> candidate_dirs = {
        ...
        "/storage/emulated/0/Android/data/dev.storm_switch/files/keys",
        "/storage/emulated/0/Android/data/dev.storm_switch.legacy/files/keys",
        "/storage/emulated/0/Android/data/dev.storm_switch.sdk27/files/keys",
        "/storage/emulated/0/Android/data/com.miHoYo.Yuanshen/files/keys",
        ...
        "/data/user/0/dev.storm_switch.legacy/files/keys",
        "/data/user/0/dev.storm_switch.sdk27/files/keys",
        "/data/user/0/com.miHoYo.Yuanshen/files/keys",
        "/data/user/0/dev.storm_eden/files/keys",
        "/data/data/dev.storm_switch/files/keys",
        "/data/data/dev.storm_switch.legacy/files/keys",
        "/data/data/dev.storm_switch.sdk27/files/keys",
        "/data/data/com.miHoYo.Yuanshen/files/keys",
