...
Write-Host "Copying freshly compiled 8.6.8 binaries from build_ninja\bin to Assembling..."
...
$zipPathWin11 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.6.8_Windows11.zip'
...
$zipPathWin10 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.6.8_Windows10.zip'
...
Write-Host "All Windows 8.6.8 executables signed and packaged successfully into E:\STORM SWITCH 4\Files!"
