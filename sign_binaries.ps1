...
Write-Host "Copying freshly compiled 8.4.0 binaries from build_ninja\bin to Assembling..."
...
$zipPathWin11 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.4.0_Windows11.zip'
...
$zipPathWin10 = 'E:\STORM SWITCH 4\Files\STORM_SWITCH_8.4.0_Windows10.zip'
...
Write-Host "All Windows 8.4.0 executables signed and packaged successfully into E:\STORM SWITCH 4\Files!"
