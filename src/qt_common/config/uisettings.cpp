...
const std::array<Shortcut, 34> default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Toggle Performance Overlay")).toStdString(), QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string("F6"),      std::string("Left_Stick+Right_Stick+Dpad_Up"), Qt::ApplicationShortcut, false}},
