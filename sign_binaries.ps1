...
Write-Host "Copying freshly compiled 8.1.0 binaries from build\bin to Assembling..."
...
Write-Host "Creating Windows 8.1.0 release zip..."
...
$zipPath = 'e:\STORM EDEN 3\Files\STORM_SWITCH_8.1.0_Windows.zip'
if (Test-Path $zipPath) { Remove-Item $zipPath -Force }

& 'C:\Program Files\7-Zip\7z.exe' a -tzip $zipPath "$stageDir\*" -mx=9

Copy-Item $zipPath 'e:\STORM EDEN 3\STORM_SWITCH_8.1.0_Windows.zip' -Force
Copy-Item $zipPath 'e:\STORM SWITCH 3\Files\STORM_SWITCH_8.1.0_Windows.zip' -Force
Copy-Item $zipPath 'e:\STORM SWITCH 3\STORM_SWITCH_8.1.0_Windows.zip' -Force
