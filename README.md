...
2. Для Android: скачайте и установите APK-файл `STORM_SWITCH_8.7.2.apk`, `STORM_SWITCH_8.7.2_LEGACY.apk` или `STORM_SWITCH_8.7.2_SDK27.apk`.
3. Для Windows: скачайте архив `STORM_SWITCH_8.7.2_Windows11.zip` (для Windows 11) или `STORM_SWITCH_8.7.2_Windows10.zip` (универсальный, с библиотеками среды выполнения MSVC CRT).
