...
static const std::vector<GameFixProfile> s_profiles = {
    ...
    },
    {
        0x010044700DEB0000ULL,
        "Assassin's Creed: The Rebel Collection",
        "• Просадки FPS до 4–6 к/с и фреймтайм 200 мс из-за сбоев композитинга и опроса серверов Ubisoft\n• Микрофризы и задержка очереди буферов в меню и морских баталиях",
        "• FPS drops to 4-6 and 200 ms frametime caused by compositor stalls and Ubisoft server queries\n• Micro-stutters and buffer queue latency during naval battles and menus",
        "✓ Режим «В самолете»: Включено (пропуск сетевого опроса Ubisoft Connect)\n✓ Асинхронный вывод кадров: Включено\n✓ Ранний сброс барьеров кадра: Включено\n✓ Сборщик мусора VRAM: Отключено (устранение фризов)\n✓ Быстрая память: Включено\n✓ Игнорировать прерывания памяти: Включено",
        "✓ Airplane Mode: Enabled (Bypasses Ubisoft Connect handshake)\n✓ Async Presentation: Enabled\n✓ Early Release Fences: Enabled\n✓ VRAM Garbage Collection: Disabled (Eliminates stutters)\n✓ Fastmem: Enabled\n✓ Ignore Memory Aborts: Enabled",
        {
            {"Renderer\\async_presentation", "true"},
            {"Renderer\\early_release_fences", "true"},
            {"Renderer\\vram_garbage_collection", "false"},
    ...
    },
    {
        0x0100670014482000ULL,
        "Assassin's Creed: The Ezio Collection",
        "• Просадки FPS до 4–6 к/с и фреймтайм 200 мс из-за сбоев композитинга и опроса серверов Ubisoft\n• Микрофризы и задержка очереди буферов в меню и городах",
        "• FPS drops to 4-6 and 200 ms frametime caused by compositor stalls and Ubisoft server queries\n• Micro-stutters and buffer queue latency in cities and menus",
        "✓ Режим «В самолете»: Включено (пропуск сетевого опроса Ubisoft Connect)\n✓ Асинхронный вывод кадров: Включено\n✓ Ранний сброс барьеров кадра: Включено\n✓ Сборщик мусора VRAM: Отключено (устранение фризов)\n✓ Быстрая память: Включено\n✓ Игнорировать прерывания памяти: Включено",
        "✓ Airplane Mode: Enabled (Bypasses Ubisoft Connect handshake)\n✓ Async Presentation: Enabled\n✓ Early Release Fences: Enabled\n✓ VRAM Garbage Collection: Disabled (Eliminates stutters)\n✓ Fastmem: Enabled\n✓ Ignore Memory Aborts: Enabled",
        {
            {"Renderer\\async_presentation", "true"},
    ...
    },
    {
        0x01007F600B134000ULL,
        "Assassin's Creed III Remastered",
        "• Просадки FPS до 4–6 к/с и фреймтайм 200 мс из-за сбоев композитинга и опроса серверов Ubisoft\n• Микрофризы и задержка очереди буферов в Бостоне и диких землях",
        "• FPS drops to 4-6 and 200 ms frametime caused by compositor stalls and Ubisoft server queries\n• Micro-stutters and buffer queue latency in Boston and frontier",
        "✓ Режим «В самолете»: Включено (пропуск сетевого опроса Ubisoft Connect)\n✓ Асинхронный вывод кадров: Включено\n✓ Ранний сброс барьеров кадра: Включено\n✓ Сборщик мусора VRAM: Отключено (устранение фризов)\n✓ Быстрая память: Включено\n✓ Игнорировать прерывания памяти: Включено",
        "✓ Airplane Mode: Enabled (Bypasses Ubisoft Connect handshake)\n✓ Async Presentation: Enabled\n✓ Early Release Fences: Enabled\n✓ VRAM Garbage Collection: Disabled (Eliminates stutters)\n✓ Fastmem: Enabled\n✓ Ignore Memory Aborts: Enabled",
        {
            {"Renderer\\async_presentation", "true"},
