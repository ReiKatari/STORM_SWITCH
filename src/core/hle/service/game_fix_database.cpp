...
static const std::vector<GameFixProfile> s_profiles = {
    ...
    {
        0x0100B99019412000ULL,
        "Mario vs. Donkey Kong",
        "• Статтеры при одновременном запуске группы мини-Марио\n• Задержки компиляции шейдеров уровней головоломок",
        "• Stutter when activating multiple Mini-Marios simultaneously\n• Shader compilation delay on puzzle stages",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100EA80032EA000ULL,
        "New Super Mario Bros. U Deluxe",
        "• Микрофризы при первом появлении боссов Купалингов\n• Задержки отклика ввода в скоростном платформинге",
        "• Microstutters on initial Koopaling boss intros\n• Input response delays in fast-paced speedruns",
        "✓ Стабильные 60 FPS\n✓ Быстрое время ГПУ: Включено\n✓ Асинхронные шейдеры: Включено",
        "✓ Stable 60 FPS\n✓ Fast GPU Time: Enabled\n✓ Asynchronous Shaders: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "• Задержки опроса сетевых сервисов на титульном экране\n• Просадки FPS в 2D-ретро дисциплинах Токио 1964",
        "• Network service query stalls on the title screen\n• Framerate drops in Tokyo 1964 2D retro disciplines",
        "✓ Режим «В самолете»: Включено\n✓ Асинхронные шейдеры: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ Airplane Mode: Enabled\n✓ Asynchronous Shaders: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01009B90006DC000ULL,
        "Super Mario Maker 2",
        "• Бесконечное ожидание серверов Course World при отсутствии подключения\n• Фризы при быстрой прокрутке уровней с сотнями элементов",
        "• Infinite waiting on Course World servers when offline\n• Freezes when fast-scrolling complex courses with hundreds of items",
        "✓ Режим «В самолете»: Включено (для плавной офлайн-игры)\n✓ Быстрая память: Включено\n✓ Асинхронные шейдеры: Включено",
        "✓ Airplane Mode: Enabled (smooth offline gameplay)\n✓ Fastmem: Enabled\n✓ Asynchronous Shaders: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
            {"Renderer\\vram_garbage_collection", "false"},
            {"Renderer\\gpu_fence_behavior", "0"},
    ...
    {
        0x010033100691A000ULL,
        "The Coma - Recut",
        "• Зависание вступительных и сюжетных видеороликов при аппаратном декодировании\n• Микрофризы при переходе между школьными коридорами\n• Ошибки затухания звука",
        "• Cutscene video freezing with hardware video decoding\n• Microstutters during school corridor transitions\n• Audio fadeout glitches",
        "✓ Видеодекодер NVDEC: ЦПУ (программный декодер устраняет зависание роликов)\n✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Режим «В самолете»: Включено",
        "✓ NVDEC Video Emulation: CPU (software decoder prevents video cutscenes from freezing)\n✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Airplane Mode: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
            {"Renderer\\vram_garbage_collection", "false"},
            {"Renderer\\gpu_fence_behavior", "0"},
    ...
    },
    {
        0x0100307018934000ULL,
        "Signalis",
        "• Задержки компиляции шейдеров CRT-развёртки и шума\n• Статтеры при открытии 3D-инвентаря и радиоприёмника",
        "• CRT scanline and film grain shader compilation stutters\n• Freezes when opening 3D inspection inventory and radio receiver",
        "✓ Стабильные 60 FPS\n✓ Асинхронные шейдеры: Включено\n✓ Быстрое время ГПУ: Включено\n✓ Быстрая память: Включено",
        "✓ Stable 60 FPS\n✓ Asynchronous Shaders: Enabled\n✓ Fast GPU Time: Enabled\n✓ Fastmem: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100FA501AF90000ULL,
        "Castlevania - Dominus Collection",
        "• Задержки отрисовки двухэкранного режима Nintendo DS\n• Сбои ввода при рисовании магических печатей и тач-управлении\n• Дрожание пиксельных шрифтов",
        "• Dual-screen Nintendo DS rendering synchronization lag\n• Touch and magic seal stylus input latency\n• Pixel font jittering",
        "✓ Сенсорное управление и стилус: Оптимизировано\n✓ Точность ГПУ: Обычная\n✓ Быстрая память: Включено\n✓ Асинхронные шейдеры: Включено",
        "✓ Touch and stylus emulation: Optimized\n✓ GPU Accuracy: Normal\n✓ Fastmem: Enabled\n✓ Asynchronous Shaders: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
            {"Renderer\\vram_garbage_collection", "false"},
            {"Renderer\\gpu_fence_behavior", "0"},
    ...
    {
        0x0100646009FBE000ULL,
        "Dead Cells",
        "• Просадки FPS при взрывах десятков врагов в биомах с модификаторами\n• Статтеры при процедурной генерации комнат",
        "• Framerate drops during multi-enemy explosions in high-cell biomes\n• Procedural room generation microstutters",
        "✓ Стабильные 60 FPS\n✓ Быстрая память: Включено\n✓ Асинхронные шейдеры: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ Stable 60 FPS\n✓ Fastmem: Enabled\n✓ Asynchronous Shaders: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01008970149B0000ULL,
        "Rabbids - Party of Legends",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Rabbids - Party of Legends",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Rabbids - Party of Legends",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        0x0100D59022590000ULL,
        "Scott Pilgrim EX",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Scott Pilgrim EX",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Scott Pilgrim EX",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100B51020B68000ULL,
        "Terminator 2D - No Fate",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Terminator 2D - No Fate",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Terminator 2D - No Fate",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x010013F009B88000ULL,
        "Xeno Crisis",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Xeno Crisis",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Xeno Crisis",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x010040502453E000ULL,
        "Vampire Crawlers",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Vampire Crawlers",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Vampire Crawlers",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        0x010094D023A28000ULL,
        "Drill Core",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Drill Core",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Drill Core",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01009D6022DC2000ULL,
        "Reus 2",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Reus 2",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Reus 2",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100FC001ACE0000ULL,
        "Anvil Saga",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Anvil Saga",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Anvil Saga",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01001B90277BE000ULL,
        "Woodo",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Woodo",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Woodo",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100304027592000ULL,
        "Urban Jungle",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Urban Jungle",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Urban Jungle",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100852026502000ULL,
        "Tyrant's Realm",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Tyrant's Realm",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Tyrant's Realm",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100C6A0235D4000ULL,
        "Devil Jam",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Devil Jam",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Devil Jam",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100E1C0252F8000ULL,
        "Maestro",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Maestro",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Maestro",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        0x0100B11027658000ULL,
        "Defender of the Crown - The Legend Returns",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Defender of the Crown - The Legend Returns",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Defender of the Crown - The Legend Returns",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в DC Super Hero Girls - Teen Power",
        "• Microstutters during asset and sprite streaming\n• Input response delays in DC Super Hero Girls - Teen Power",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Tokyo 2020 Olympics - The Official Video Game",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Tokyo 2020 Olympics - The Official Video Game",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x0100BB901FA12000ULL,
        "Little Big Adventure - Twinsen's Quest",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в Little Big Adventure - Twinsen's Quest",
        "• Microstutters during asset and sprite streaming\n• Input response delays in Little Big Adventure - Twinsen's Quest",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01005EC01E6A4000ULL,
        "The Art of Dave the Diver - Digital Artbook",
        "• Микрофризы при подгрузке ассетов и спрайтов\n• Задержки отклика ввода в The Art of Dave the Diver - Digital Artbook",
        "• Microstutters during asset and sprite streaming\n• Input response delays in The Art of Dave the Diver - Digital Artbook",
        "✓ Точность ГПУ: Обычная\n✓ Асинхронные шейдеры: Включено\n✓ Быстрая память: Включено\n✓ Быстрое время ГПУ: Включено",
        "✓ GPU Accuracy: Normal\n✓ Asynchronous Shaders: Enabled\n✓ Fastmem: Enabled\n✓ Fast GPU Time: Enabled",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Super Mario Bros. Remastered",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Super Mario Bros. Remastered",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
            {"Renderer\\vram_garbage_collection", "false"},
    ...
    {
        0x0132B3143DF50000ULL,
        "Super Mario Bros. X",
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Super Mario Bros. X",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Super Mario Bros. X",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x01849C8CA8080000ULL,
        "Mario Kart 64",
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Mario Kart 64",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Mario Kart 64",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    {
        0x058E630A38C70000ULL,
        "Diablo - Hellfire",
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Diablo - Hellfire",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Diablo - Hellfire",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "Gizmoduck",
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Gizmoduck",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Gizmoduck",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
    ...
    },
    {
        ...
        "Dr. Mario Mania",
        "• Сбои инициализации кастомного homebrew-загрузчика\n• Ошибки выделения памяти неофициального порта Dr. Mario Mania",
        "• Custom homebrew loader initialization errors\n• Memory allocation anomalies in unofficial port Dr. Mario Mania",
        "✓ Память DRAM: Стандартная 4 ГБ\n✓ Игнорирование прерываний памяти: Включено\n✓ Быстрая память: Включено\n✓ Точность ГПУ: Обычная",
        "✓ DRAM Memory Layout: 4GB Standard\n✓ Ignore Memory Aborts: Enabled\n✓ Fastmem: Enabled\n✓ GPU Accuracy: Normal",
        {
            {"Renderer\\gpu_accuracy", "0"},
