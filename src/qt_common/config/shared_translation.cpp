...
#define INSERT(SETTINGS, ID, NAME, TOOLTIP)                                                        \
    ...
    INSERT(Settings, renderer_force_max_clock, tr("Фиксация максимальной частоты ГПУ"),
           tr("Запрещает видеодрайверу сбрасывать частоты видеокарты в простых сценах, устраняя микростаттеры."));
