...
#define PAIR(ENUM, VALUE, TRANSLATION) {static_cast<u32>(Settings::ENUM::VALUE), (TRANSLATION)}
    ...
    translations->insert(
        {Settings::EnumMetadata<Settings::Language>::Index(),
         {
             PAIR(Language, Japanese, tr("Japanese (ж—Ґжњ¬иЄћ)")),
             PAIR(Language, EnglishAmerican, tr("American English")),
             PAIR(Language, French, tr("French (franГ§ais)")),
             PAIR(Language, German, tr("German (Deutsch)")),
             PAIR(Language, Italian, tr("Italian (italiano)")),
             PAIR(Language, Spanish, tr("Spanish (espaГ±ol)")),
             PAIR(Language, Chinese, tr("Chinese")),
             PAIR(Language, Korean, tr("Korean (н•њкµ­м–ґ)")),
             PAIR(Language, Dutch, tr("Dutch (Nederlands)")),
             PAIR(Language, Portuguese, tr("Portuguese (portuguГЄs)")),
             PAIR(Language, Russian, tr("Russian (Р СѓСЃСЃРєРёР№)")),
             ...
             PAIR(Language, ChineseTraditional, tr("Traditional Chinese (ж­Јй«”дё­ж–‡)")),
             PAIR(Language, PortugueseBrazilian, tr("Brazilian Portuguese (portuguГЄs do Brasil)")),
             PAIR(Language, Polish, tr("Polish (polska)")),
             PAIR(Language, Thai, tr("Thai (а№Ѓаёљаёља№„аё—аёў)")),
         }});
